...
public class FileReaders {
	public FileReaders (){
		...
		System.out.println(System.currentTimeMillis());
		externals_types[0]="sample";
		externals_links[0]="HG00096:HG00097";
		...
		System.out.println(i1.add_Tracks(externals,externals_modes));
		System.out.println(System.currentTimeMillis());
		System.out.println(i1.add_Pvar("1000g", Consts.MODE_PACK, "HG00096"));
		...
		externals[0]="GWASCatalog";externals_links[0]="http://202.118.228.68/gbfiles/GwasCatalog.hg19.sorted.gdf.gz";externals_types[0]=Consts.FORMAT_GDF;externals_modes[0]=Consts.MODE_PACK;
		i1.add_Externals(externals,externals_links,externals_types,externals_modes);
		System.out.println(i1.add_Tracks(externals,externals_modes));
