...
public class FileReaders {
	public FileReaders (){
		...
		System.out.println(i1.get_Annotations());
		System.out.println(System.currentTimeMillis());
		System.out.println(i1.update("chr1",30031597,33041570,1350));
		System.out.println(System.currentTimeMillis());
		String[] externals={"RefSeq"};
		String[] externals_links={"input/refGene.hg19.sorted.anno.gz"};
		String[] externals_types={"ANNO"};
		...
		System.out.println(i1.add_Tracks(externals,externals_modes));
		System.out.println(System.currentTimeMillis());
/*		externals[0]="BamTest";externals_links[0]="http://202.118.228.68/gbfiles/MCF7_DNAseq.hg19.sorted.bam";externals_types[0]="BAM";externals_modes[0]=Consts.MODE_DETAIL;
		i1.add_Externals(externals,externals_links,externals_types,externals_modes);
		System.out.println(i1.add_Tracks(externals,externals_modes));
		System.out.println(System.currentTimeMillis());
